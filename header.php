  ...
  <div class="wrapper">
    <header id="header" itemscope="" itemtype="https://schema.org/WPHeader">
      <ul class="header-box" itemscope="" itemtype="https://schema.org/SiteNavigationElement">
        <li>
          <!-- ▼　トップ画像を変更して、あなたのブログにオリジナリティーを出してみましょう ▼ --><a href="https://illust-diary.net">
            <img src="http://www.irasuto.cfbx.jp/wp-content/themes/sample_theme/images/main-banner.jpg" alt="" style="height:230px;width:555px;"></a>
          <!-- ▲　画像の推奨サイズは "1100px×200px" となっております。 横幅だけでも合わせておきましょう ▲ -->
          <!--▼ メニューバー ▼-->
          <ul id="menu_bar">
            <li><a href="illust-diary.net">サイト(ABOUT)</a></li>
